...
{
    public class CustomerHeaderViewComponent
        : ViewComponent
    {
        private readonly CareConnectDbContext _context;

        public CustomerHeaderViewComponent(
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var thongBaoGanDay =
                await _context.ThongBaos
                    ...
                    .Take(7)
                    .Select(x =>
                        new CustomerHeaderNotificationViewModel
                        {
                            MaThongBao =
                                x.MaThongBao,
